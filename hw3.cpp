				...
				{				
					...
					if(x==7 && y==7)
					{
						for(int i=0;i<5;i+=4)
						{
							for(int j=1;j<5;j++)
							{
								if(color[i][j]==0 && (color[i][j-1]==inputColor || color[i][j+1]==inputColor))
								{
									x=i;
									y=j;
								}
					...
					if(x==7 && y==7)
					{
						for(int i=1;i<4;i++)
						{
							for(int j=0;j<6;j+=5)
							{
								if(color[i][j]==0 && (color[i-1][j]==inputColor || color[i+1][j]==inputColor))
								{
									x=i;
									y=j;
								}
					...
					if(x==7 && y==7)
					{
						for(int i=1;i<4;i++)
						{
							for(int j=1;j<5;j++)
							{
								if(color[i][j]==0 && color[i-1][j]!=(3-inputColor) && color[i+1][j]!=(3-inputColor) && color[i][j-1]!=(3-inputColor))
								{
									x=i;
									y=j;
								}
					...
					if(x==7 && y==7)
					{
						for(int i=1;i<4;i++)
						{
							for(int j=1;j<5;j++)
							{
								if(color[i][j]==0 && color[i-1][j]!=(3-inputColor) && color[i][j-1]!=(3-inputColor) && color[i][j+1]!=(3-inputColor))
								{
									x=i;
									y=j;
								}
